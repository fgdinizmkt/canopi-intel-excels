...
- C2.7 concluído e publicado: Salesforce recebeu teste real mínimo server-side e a navegação de Configurações ganhou acesso direto para Fontes e Conectores.
