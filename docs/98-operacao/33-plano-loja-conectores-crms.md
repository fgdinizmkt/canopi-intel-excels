...
- Próximo passo natural: recorte posterior de dry-run read-only multi-entidade Salesforce; depois marcos de Sync Read-only, Mapping persistente, Bulk API, Writeback seguro, Test Data Pack e Connector completo.
...
- Salesforce Dry-run read-only multi-entidade
